if mods["Krastorio2"] then
    local function createMachine(name)
        ...
        cm.localised_name = lm_localised_name("logistic-" .. name, "")
    ...
    local function createLab(name)
        ...
        if name == "biusart-lab" then
            ...
            cl.localised_name = lm_localised_name("logistic-advanced-lab", "")
        else
            ...
            cl.localised_name = lm_localised_name("logistic-singularity-lab", "")
        end
        cl.icon_size = 64
